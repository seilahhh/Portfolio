        ...
        >
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-7 gap-4">
                <div className="col-span-5 flex flex-col justify-center items-start">
                    <div
                        id="profile"
                        className="space-y-4 uppercase mb-12 md:m-0"
                    >
                        <h1 className="text-primary text-3xl md:text-5xl lg:text-7xl">
                            ...
                            />
                            <span className="sr-only">Joaquim Pereira</span>
                        </h1>
                        ...
                        <div id="social-media">
                            <a
                                className="mx-2 text-md md:text-xl lg:text-2xl"
                                href="https://github.com/seilahhh"
                                target="_blank"
                                rel="noreferrer"
                                aria-label="GitHub de Joaquim Pereira"
                            >
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                aria-label="Linkedin de Joaquim Pereira"
                            >
                ...
                <div className="col-span-2 flex flex-col justify-center items-start">
                    <p className="text-md md:text-lg mt-10">
                        Olá!
                        <br />
                        Seja bem vindo ao meu porfólio.
                        <br />
                        <br />
                        Aqui poderá conhecer o meu trabalho e a minha
                        participação em alguns projetos.
                        <br />
                        <br />
                        Apresento abaixo mais algumas informações sobre mim.
                    </p>
                </div>
            </div>
        </section>
